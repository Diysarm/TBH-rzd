...
export const IPC = {
  ...
  MARK_SLOT_CHEST_DROPPED: "mark-slot-chest-dropped",
  CLEAR_SLOT_CHEST_TIMER: "clear-slot-chest-timer",
  SET_SLOT_CHEST_COOLDOWN: "set-slot-chest-cooldown",
  CLEAR_SLOT_CHEST_COOLDOWN: "clear-slot-chest-cooldown",
  ...
  SET_BOX_TRACKER_CLEAR_TIME: "set-box-tracker-clear-time",
  CLEAR_BOX_TRACKER_CLEAR_TIME: "clear-box-tracker-clear-time",
...
export const IPC_INVOKE_CHANNELS = [
  ...
  IPC.CLEAR_BOX_TIMER,
  IPC.MARK_SLOT_CHEST_DROPPED,
  IPC.CLEAR_SLOT_CHEST_TIMER,
  IPC.SET_SLOT_CHEST_COOLDOWN,
  IPC.CLEAR_SLOT_CHEST_COOLDOWN,
  IPC.SET_BOX_TRACKER_BOXES,
  IPC.SET_BOX_TRACKER_COOLDOWN,
  IPC.CLEAR_BOX_TRACKER_COOLDOWN,
  IPC.SET_BOX_TRACKER_CLEAR_TIME,
  IPC.CLEAR_BOX_TRACKER_CLEAR_TIME,
